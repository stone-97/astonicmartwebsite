...
@Component({
  selector: 'app-generalconcreteequipment',
  templateUrl: './generalconcreteequipment.component.html',
  styleUrl: './generalconcreteequipment.component.css'
})
export class GeneralconcreteequipmentComponent {

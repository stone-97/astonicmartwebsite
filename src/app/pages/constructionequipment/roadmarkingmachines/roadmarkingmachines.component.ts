...
@Component({
  selector: 'app-roadmarkingmachines',
  templateUrl: './roadmarkingmachines.component.html',
  styleUrl: './roadmarkingmachines.component.css'
})
export class RoadmarkingmachinesComponent {

...
@Component({
  selector: 'app-drumrollercompactors',
  templateUrl: './drumrollercompactors.component.html',
  styleUrl: './drumrollercompactors.component.css'
})
export class DrumrollercompactorsComponent {

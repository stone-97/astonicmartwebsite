...
@Component({
  selector: 'app-breathingapparatus',
  templateUrl: './breathingapparatus.component.html',
  styleUrl: './breathingapparatus.component.css'
})
export class BreathingapparatusComponent {

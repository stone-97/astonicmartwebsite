...
@Component({
  selector: 'app-tapesandadhesives',
  templateUrl: './tapesandadhesives.component.html',
  styleUrl: './tapesandadhesives.component.css'
})
export class TapesandadhesivesComponent {

...
@Component({
  selector: 'app-weldingprotectionwears',
  templateUrl: './weldingprotectionwears.component.html',
  styleUrl: './weldingprotectionwears.component.css'
})
export class WeldingprotectionwearsComponent {

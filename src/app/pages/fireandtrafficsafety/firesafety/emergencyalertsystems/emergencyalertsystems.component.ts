...
@Component({
  selector: 'app-emergencyalertsystems',
  templateUrl: './emergencyalertsystems.component.html',
  styleUrl: './emergencyalertsystems.component.css'
})
export class EmergencyalertsystemsComponent {

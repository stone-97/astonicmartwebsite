...
@Component({
  selector: 'app-trafficandsolarlights',
  templateUrl: './trafficandsolarlights.component.html',
  styleUrl: './trafficandsolarlights.component.css'
})
export class TrafficandsolarlightsComponent {

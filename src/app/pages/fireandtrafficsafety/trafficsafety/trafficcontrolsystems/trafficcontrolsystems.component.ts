...
@Component({
  selector: 'app-trafficcontrolsystems',
  templateUrl: './trafficcontrolsystems.component.html',
  styleUrl: './trafficcontrolsystems.component.css'
})
export class TrafficcontrolsystemsComponent {

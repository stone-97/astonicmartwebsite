...
@Component({
  selector: 'app-dredgepipefloaters',
  templateUrl: './dredgepipefloaters.component.html',
  styleUrl: './dredgepipefloaters.component.css'
})
  
  
export class DredgepipefloatersComponent {

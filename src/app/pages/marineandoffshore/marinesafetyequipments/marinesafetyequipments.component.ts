...
@Component({
  selector: 'app-marinesafetyequipments',
  templateUrl: './marinesafetyequipments.component.html',
  styleUrl: './marinesafetyequipments.component.css'
})
export class MarinesafetyequipmentsComponent {

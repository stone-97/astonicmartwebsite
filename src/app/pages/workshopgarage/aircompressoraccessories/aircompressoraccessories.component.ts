...
@Component({
  selector: 'app-aircompressoraccessories',
  templateUrl: './aircompressoraccessories.component.html',
  styleUrl: './aircompressoraccessories.component.css'
})
export class AircompressoraccessoriesComponent {

...
@Component({
  selector: 'app-hydraulicshoppress',
  templateUrl: './hydraulicshoppress.component.html',
  styleUrl: './hydraulicshoppress.component.css'
})
export class HydraulicshoppressComponent {

...
@Component({
  selector: 'app-oilextractorsanddrainers',
  templateUrl: './oilextractorsanddrainers.component.html',
  styleUrl: './oilextractorsanddrainers.component.css'
})
export class OilextractorsanddrainersComponent {

...
@Component({
  selector: 'app-generalautomotivetools',
  templateUrl: './generalautomotivetools.component.html',
  styleUrl: './generalautomotivetools.component.css'
})
export class GeneralautomotivetoolsComponent {

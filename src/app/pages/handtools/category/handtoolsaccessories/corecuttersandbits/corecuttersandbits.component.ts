...
@Component({
  selector: 'app-corecuttersandbits',
  templateUrl: './corecuttersandbits.component.html',
  styleUrl: './corecuttersandbits.component.css'
})
export class CorecuttersandbitsComponent {

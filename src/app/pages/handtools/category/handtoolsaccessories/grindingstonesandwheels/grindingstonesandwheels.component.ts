...
@Component({
  selector: 'app-grindingstonesandwheels',
  templateUrl: './grindingstonesandwheels.component.html',
  styleUrl: './grindingstonesandwheels.component.css'
})
export class GrindingstonesandwheelsComponent {

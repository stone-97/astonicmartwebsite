...
@Component({
  selector: 'app-utilityknivesandblades',
  templateUrl: './utilityknivesandblades.component.html',
  styleUrl: './utilityknivesandblades.component.css'
})
export class UtilityknivesandbladesComponent {

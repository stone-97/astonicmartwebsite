...
@Component({
  selector: 'app-pipecutters',
  templateUrl: './pipecutters.component.html',
  styleUrl: './pipecutters.component.css'
})
export class PipecuttersComponent {

...
@Component({
  selector: 'app-handtoolsmeasuringtapes',
  templateUrl: './handtoolsmeasuringtapes.component.html',
  styleUrl: './handtoolsmeasuringtapes.component.css'
})
export class HandtoolsMeasuringtapesComponent {

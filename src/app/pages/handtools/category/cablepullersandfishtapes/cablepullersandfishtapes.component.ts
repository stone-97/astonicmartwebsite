...
@Component({
  selector: 'app-cablepullersandfishtapes',
  templateUrl: './cablepullersandfishtapes.component.html',
  styleUrl: './cablepullersandfishtapes.component.css'
})
export class CablepullersandfishtapesComponent {

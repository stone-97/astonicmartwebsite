...
@Component({
  selector: 'app-autocompressors',
  templateUrl: './autoaircompressors.component.html',
  styleUrl: './autoaircompressors.component.css'
})
export class AutoaircompressorsComponent {

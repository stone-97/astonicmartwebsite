...
@Component({
  selector: 'app-solderingequipment',
  templateUrl: './solderingequipment.component.html',
  styleUrl: './solderingequipment.component.css'
})
export class SolderingequipmentComponent {

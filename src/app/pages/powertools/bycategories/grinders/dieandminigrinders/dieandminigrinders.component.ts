...
@Component({
  selector: 'app-minigrinders',
  templateUrl: './dieandminigrinders.component.html',
  styleUrl: './dieandminigrinders.component.css'
})
export class DieandminigrindersComponent {

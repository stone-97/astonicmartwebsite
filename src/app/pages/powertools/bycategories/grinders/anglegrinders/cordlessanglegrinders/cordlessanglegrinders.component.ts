...
@Component({
  selector: 'app-cordlessanglegrinders',
  templateUrl: './cordlessanglegrinders.component.html',
  styleUrl: './cordlessanglegrinders.component.css'
})
export class CordlessanglegrindersComponent {

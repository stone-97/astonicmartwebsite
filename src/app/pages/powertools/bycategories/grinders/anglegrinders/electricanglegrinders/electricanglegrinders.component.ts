...
@Component({
  selector: 'app-electricanglegrinders',
  templateUrl: './electricanglegrinders.component.html',
  styleUrl: './electricanglegrinders.component.css'
})
export class ElectricanglegrindersComponent {

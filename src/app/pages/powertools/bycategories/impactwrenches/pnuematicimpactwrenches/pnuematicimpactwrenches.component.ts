...
@Component({
  selector: 'app-pnuematic',
  templateUrl: './pnuematicimpactwrenches.component.html',
  styleUrl: './pnuematicimpactwrenches.component.css'
})
export class PnuematicimpactwrenchesComponent {

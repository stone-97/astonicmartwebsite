...
@Component({
  selector: 'app-gasolinejackhammers',
  templateUrl: './gasolinejackhammers.component.html',
  styleUrl: './gasolinejackhammers.component.css'
})
export class GasolinejackhammersComponent {

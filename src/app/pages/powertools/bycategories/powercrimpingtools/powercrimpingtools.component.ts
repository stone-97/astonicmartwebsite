...
@Component({
  selector: 'app-powercrimpingtools',
  templateUrl: './powercrimpingtools.component.html',
  styleUrl: './powercrimpingtools.component.css'
})
export class PowercrimpingtoolsComponent {

...
@Component({
  selector: 'app-electricalcablepullers',
  templateUrl: './electricalcablepullers.component.html',
  styleUrl: './electricalcablepullers.component.css'
})
export class ElectricalcablepullersComponent {

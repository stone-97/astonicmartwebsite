...
@Component({
  selector: 'app-electricrotaryhammerdrills',
  templateUrl: './electricrotaryhammerdrills.component.html',
  styleUrl: './electricrotaryhammerdrills.component.css'
})
export class ElectricrotaryhammerdrillsComponent {

...
@Component({
  selector: 'app-cordlessrotaryhammerdrills',
  templateUrl: './cordlessrotaryhammerdrills.component.html',
  styleUrl: './cordlessrotaryhammerdrills.component.css'
})
export class CordlessrotaryhammerdrillsComponent {

...
@Component({
  selector: 'app-ppr',
  templateUrl: './pprandthreadingmachines.component.html',
  styleUrl: './pprandthreadingmachines.component.css'
})
export class PprandthreadingmachinesComponent {

...
@Component({
  selector: 'app-airlesssprayers',
  templateUrl: './airlesssprayers.component.html',
  styleUrl: './airlesssprayers.component.css'
})
export class AirlesssprayersComponent {
  ...
  ngOnInit() {
    ...
    // load airless sprayer products
    this.products =
      this.SearchService.getProductsByCategory('airless-sprayers');

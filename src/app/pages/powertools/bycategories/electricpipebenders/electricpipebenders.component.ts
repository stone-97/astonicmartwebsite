...
@Component({
  selector: 'app-electricpipebenders',
  templateUrl: './electricpipebenders.component.html',
  styleUrl: './electricpipebenders.component.css'
})
export class ElectricpipebendersComponent {

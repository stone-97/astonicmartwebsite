...
@Component({
  selector: 'app-caulkingandpufoamguns',
  templateUrl: './caulkingandpufoamguns.component.html',
  styleUrl: './caulkingandpufoamguns.component.css'
})
export class CaulkingandpufoamgunsComponent {

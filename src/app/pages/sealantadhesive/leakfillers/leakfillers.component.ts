...
@Component({
  selector: 'app-spraypaints',
  templateUrl: './leakfillers.component.html',
  styleUrl: './leakfillers.component.css'
})
export class LeakfillersComponent {

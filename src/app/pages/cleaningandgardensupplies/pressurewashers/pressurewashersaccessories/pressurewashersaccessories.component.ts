...
@Component({
  selector: 'app-pressurewashersaccessories',
  templateUrl: './pressurewashersaccessories.component.html',
  styleUrl: './pressurewashersaccessories.component.css'
})
export class PressurewashersaccessoriesComponent {

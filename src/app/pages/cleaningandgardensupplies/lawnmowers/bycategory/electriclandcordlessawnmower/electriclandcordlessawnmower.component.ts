...
@Component({
  selector: 'app-electriclandcordlessawnmower',
  templateUrl: './electriclandcordlessawnmower.component.html',
  styleUrl: './electriclandcordlessawnmower.component.css'
})
export class ElectricandcordlesslawnmowerComponent {

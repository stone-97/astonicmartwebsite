...
@Component({
  selector: 'app-gasolinelawnmowe',
  templateUrl: './gasolinelawnmower.component.html',
  styleUrl: './gasolinelawnmower.component.css'
})
export class GasolinelawnmowerComponent {

...
@Component({
  selector: 'app-industrialvacummcleaners',
  templateUrl: './industrialvacummcleaners.component.html',
  styleUrl: './industrialvacummcleaners.component.css'
})
export class IndustrialvacummcleanersComponent {

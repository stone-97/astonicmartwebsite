...
@Component({
  selector: 'app-steamcleanermachines',
  templateUrl: './steamcleanermachines.component.html',
  styleUrl: './steamcleanermachines.component.css'
})
export class SteamcleanermachinesComponent {

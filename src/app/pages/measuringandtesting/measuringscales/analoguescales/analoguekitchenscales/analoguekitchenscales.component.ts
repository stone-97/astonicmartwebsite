...
@Component({
  selector: 'app-analoguekitchenscales',
  templateUrl: './analoguekitchenscales.component.html',
  styleUrl: './analoguekitchenscales.component.css'
})
export class AnaloguekitchenscalesComponent {

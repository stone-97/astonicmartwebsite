...
@Component({
  selector: 'app-surveyinstruments',
  templateUrl: './surveyinstruments.component.html',
  styleUrl: './surveyinstruments.component.css'
})
export class SurveyinstrumentsComponent {

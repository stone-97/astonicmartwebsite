...
@Component({
  selector: 'app-digitalthermometers',
  templateUrl: './digitalthermometers.component.html',
  styleUrl: './digitalthermometers.component.css'
})
export class DigitalthermometersComponent {

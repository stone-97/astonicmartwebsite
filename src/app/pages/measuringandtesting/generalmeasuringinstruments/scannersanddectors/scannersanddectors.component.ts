...
@Component({
  selector: 'app-scannersanddectors',
  templateUrl: './scannersanddectors.component.html',
  styleUrl: './scannersanddectors.component.css'
})
export class ScannersanddectorsComponent {

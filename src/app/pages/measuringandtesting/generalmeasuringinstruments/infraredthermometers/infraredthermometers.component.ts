...
@Component({
  selector: 'app-infraredthermometers',
  templateUrl: './infraredthermometers.component.html',
  styleUrl: './infraredthermometers.component.css'
})
export class InfraredthermometersComponent {

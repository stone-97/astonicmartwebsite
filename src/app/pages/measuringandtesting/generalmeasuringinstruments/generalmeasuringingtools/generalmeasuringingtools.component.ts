...
@Component({
  selector: 'app-generalmeasuringingtools',
  templateUrl: './generalmeasuringingtools.component.html',
  styleUrl: './generalmeasuringingtools.component.css'
})
export class GeneralmeasuringingtoolsComponent {

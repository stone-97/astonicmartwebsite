...
@Component({
  selector: 'app-moistureanalyzers',
  templateUrl: './moistureanalyzers.component.html',
  styleUrl: './moistureanalyzers.component.css'
})
export class MoistureanalyzersComponent {

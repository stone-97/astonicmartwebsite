...
@Component({
  selector: 'app-chemicalapplicationsandsprayer',
  templateUrl: './chemicalapplicationsandsprayer.component.html',
  styleUrl: './chemicalapplicationsandsprayer.component.css'
})
export class ChemicalapplicationsandsprayerComponent {
  ...
  ngOnInit() {
    ...
    this.products =
      this.SearchService.getProductsByCategory(
        'chemical-applications-and-sprayers');
